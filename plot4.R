...
with(Consump,plot(x, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
...
with(Consump,plot(x, Voltage, type="l", xlab="datetime", ylab="Voltage"))
with(Consump,plot(x, Global_reactive_power, type="l", xlab="datetime", ylab="Global Reactive Power"))
dev.off()